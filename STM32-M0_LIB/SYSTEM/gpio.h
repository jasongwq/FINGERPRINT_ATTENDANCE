...
#define Get_A0   ((GPIOA->ODR&(1<<0))?1:0)
#define Get_A1   ((GPIOA->ODR&(1<<1))?1:0)
#define Get_A2   ((GPIOA->ODR&(1<<2))?1:0)
#define Get_A3   ((GPIOA->ODR&(1<<3))?1:0)
#define Get_A4   ((GPIOA->ODR&(1<<4))?1:0)
#define Get_A5   ((GPIOA->ODR&(1<<5))?1:0)
#define Get_A6   ((GPIOA->ODR&(1<<6))?1:0)
#define Get_A7   ((GPIOA->ODR&(1<<7))?1:0)
#define Get_A8   ((GPIOA->ODR&(1<<8))?1:0)
#define Get_A9   ((GPIOA->ODR&(1<<9))?1:0)
#define Get_A10  ((GPIOA->ODR&(1<<10))?1:0)
#define Get_A11  ((GPIOA->ODR&(1<<11))?1:0)
#define Get_A12  ((GPIOA->ODR&(1<<12))?1:0)
#define Get_A13  ((GPIOA->ODR&(1<<13))?1:0)
#define Get_A14  ((GPIOA->ODR&(1<<14))?1:0)
#define Get_A15  ((GPIOA->ODR&(1<<15))?1:0)
#define Get_A(n) ((GPIOA->ODR&(1<<n))?1:0)
...
#define Get_B0   ((GPIOB->ODR&(1<<0))?1:0)
#define Get_B1   ((GPIOB->ODR&(1<<1))?1:0)
#define Get_B2   ((GPIOB->ODR&(1<<2))?1:0)
#define Get_B3   ((GPIOB->ODR&(1<<3))?1:0)
#define Get_B4   ((GPIOB->ODR&(1<<4))?1:0)
#define Get_B5   ((GPIOB->ODR&(1<<5))?1:0)
#define Get_B6   ((GPIOB->ODR&(1<<6))?1:0)
#define Get_B7   ((GPIOB->ODR&(1<<7))?1:0)
#define Get_B8   ((GPIOB->ODR&(1<<8))?1:0)
#define Get_B9   ((GPIOB->ODR&(1<<9))?1:0)
#define Get_B10  ((GPIOB->ODR&(1<<10))?1:0)
#define Get_B11  ((GPIOB->ODR&(1<<11))?1:0)
#define Get_B12  ((GPIOB->ODR&(1<<12))?1:0)
#define Get_B13  ((GPIOB->ODR&(1<<13))?1:0)
#define Get_B14  ((GPIOB->ODR&(1<<14))?1:0)
#define Get_B15  ((GPIOB->ODR&(1<<15))?1:0)
#define Get_B(n) ((GPIOB->ODR&(1<<n))?1:0)
...
#define Get_F0   ((GPIOF->ODR&(1<<0))?1:0)
#define Get_F1   ((GPIOF->ODR&(1<<1))?1:0)
#define Get_F2   ((GPIOF->ODR&(1<<2))?1:0)
#define Get_F3   ((GPIOF->ODR&(1<<3))?1:0)
#define Get_F4   ((GPIOF->ODR&(1<<4))?1:0)
#define Get_F5   ((GPIOF->ODR&(1<<5))?1:0)
#define Get_F6   ((GPIOF->ODR&(1<<6))?1:0)
#define Get_F7   ((GPIOF->ODR&(1<<7))?1:0)
#define Get_F8   ((GPIOF->ODR&(1<<8))?1:0)
#define Get_F9   ((GPIOF->ODR&(1<<9))?1:0)
#define Get_F10  ((GPIOF->ODR&(1<<10))?1:0)
#define Get_F11  ((GPIOF->ODR&(1<<11))?1:0)
#define Get_F12  ((GPIOF->ODR&(1<<12))?1:0)
#define Get_F13  ((GPIOF->ODR&(1<<13))?1:0)
#define Get_F14  ((GPIOF->ODR&(1<<14))?1:0)
#define Get_F15  ((GPIOF->ODR&(1<<15))?1:0)
#define Get_F(n) ((GPIOF->ODR&(1<<n))?1:0)
