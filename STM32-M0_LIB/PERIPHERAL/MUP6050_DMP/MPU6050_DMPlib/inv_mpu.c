...
#define log_e    USART_OUT(USART1,//printf//
#define log_i		USART_OUT(USART1,//printf//
...
//            log_e("Unsupported software product rev d.\n");
            USART_OUT(DEBUG_USART,"Unsupported software product rev d.\n");
        ...
        //        "incompatible or an MPU3050.\n");
					USART_OUT(DEBUG_USART,"Product ID read as 0 indicates device is either "
                "incompatible or an MPU3050.\n");
            return -1;
        } else if (rev == 4) {
         //   log_i("Half sensitivity part found.\n");
					USART_OUT(DEBUG_USART,"Half sensitivity part found.\n");
            st.chip_cfg.accel_half = 1;
        } else
            st.chip_cfg.accel_half = 0;
    }
